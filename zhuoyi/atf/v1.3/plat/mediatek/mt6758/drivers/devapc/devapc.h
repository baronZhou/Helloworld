...
#define DAPC_PERI_ATTR(DEV_NAME, PERM_ATTR1, PERM_ATTR2) {(unsigned char)PERM_ATTR1, (unsigned char)PERM_ATTR2}

struct SSPM_DEVICE_INFO {
	unsigned char       d5_permission;
};

#define DAPC_SSPM_ATTR(DEV_NAME, PERM_ATTR1) {(unsigned char)PERM_ATTR1}
...
#define SLAVE_MM_MAX_INDEX              114
#define SLAVE_MD_MAX_INDEX              52
#define SLAVE_PERI_MAX_INDEX            47

#define INFRA_MM_MD_MAX_VIO_INDEX       212
#define PERI_MAX_VIO_INDEX              51
