...
#endif
#include "sf_ctl.h"
#include "../../../spi/mediatek/mt6763/mtk_spi.h"      //add by micheal 20180228
...
static char fingerprint_chip[20] = "v";
//static int read_sunwave_chip_id = 0;
static hw_module_info hw_info = {
	.type = HW_MODULE_TYPE_FP,
	.id = 0xFFFF,
	.priority = HW_MODULE_PRIORITY_FP,
	.name = fingerprint_chip,
	.vendor = "vendor",
	.more = "already"
};
...
struct mt_spi_t *mt_spi_tee = NULL;
...
static struct of_device_id  sf_of_match[] = {
    ...
    { .compatible = "mediatek,spi0_fingerprint", },
#else
...
static int sf_probe(struct spi_device *spi)
{
    ...
    mt_spi_tee = spi_master_get_devdata(sf_spi->master);
	...
	//hw_info.id = read_sunwave_chip_id;
	sprintf(fingerprint_chip,"SW531B");
